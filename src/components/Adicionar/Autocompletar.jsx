...
export default function FreeSoloCreateOptionDialog() {
    ...
    const addCateoria=(newValue)=>{
        ...
        //     }
        // };
        // axios.post(Url+"categoria_post", axiosConfig,casas).then((response) => {
        ...
        axios.post(Url+"categoria_post",{nombre: "csasas"}).then(res=>{
            console.log(newValue);
        });

        // axios({
        //     method: 'post',
        //     url: Url+"categoria_post",
        //     data: "casas",
        //     header: {
    ...
    return (
        <React.Fragment>
            <Autocomplete
                ...
                freeSolo
                renderInput={(params) => (
                    <TextField {...params} label="Seleccione una categoría" variant="outlined" />
                )}
            />
